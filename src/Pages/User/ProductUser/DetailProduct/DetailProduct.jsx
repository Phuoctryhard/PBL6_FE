...
// import './Gallery.css'
// import ModalGalary from './ModalGalary'
...
//       data.data.data.items = getImage(data.data.data)
//       setImages(data.data.data.items)
//     }
//   }, [data])
...
//       data.product_images.map((element) => {
//         images.push({
//           original: element,
//           thumbnail: element,
//           // css poiter
...
//   const images = [
//     {
//       original: 'https://prod-cdn.pharmacity.io/e-com/images/ecommerce/500x500/P22255_3.png',
//       thumbnail: 'https://picsum.photos/id/1018/250/150/',
//       originalClass: 'original-image',
//       thumbnailClass: 'thumbnail-image',
//       originalHeight: 800, // Chiều cao ảnh gốc (tăng giá trị này để tăng kích thước ảnh)
//       originalWidth: 800, // Chiều rộng ảnh gốc
//       loading: 'lazy', // Tải ảnh lười hoặc eager
...
//   const handle_getImage_index = () => {
//     // cap nhat lai index slider hien tai
//     const index = refGallery?.current?.getCurrentIndex() // Lấy index hiện tại
...
//               <div className='col-span-12 md:col-span-9 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 ml-0 md:ml-4'>
//                 {/* trai:    */}
//                 <div className='col-span-2 border-b-2  md:block hidden '>
...
//                       onClick={() => handle_getImage_index()}
//                     />
//                   </div>
//                 </div>
//                 {/* end trai:    */}
//                 <div className='bg-white md:col-span-2 border-b-2 '>
...
//                   {data?.data?.data.parent_category_name === 'Thuốc kê đơn' ? (
//                     <></>
//                   ) : (
//                     <>
...
//                             style: 'currency',
//                             currency: 'VND'
//                           }).format(data.data.data.product_price ?? 0)}
//                         </h3>
...
//                             <span class='inline pe-1 font-semibold'>Giao Nhanh 2H</span>áp dụng tùy khu vực, xem dự kiến
//                             thời gian hàng ở trang thanh toán
//                           </p>
//                         </div>
//                       </div>
//                     </div>
...
//                         <div className='pmc-content-html' dangerouslySetInnerHTML={{ __html: sanitizedDescription }} />
//                       )}
//                     </div>
//                   </div>
...
//                   {data?.data?.data.parent_category_name === 'Thuốc kê đơn' ? (
//                     <>
//                       <div className='font-semibold'>Hệ thống nhà thuốc</div>
//                       <div className='my-6'>
//                         <Divider Solid className='h-[1px] bg-gray-300' />
//                         <button className='text-center w-full mt-4 bg-blue rounded-lg p-2'>Gọi tư vấn</button>
...
//                         <div
//                           className='p-3 w-full bg-[#1A51A2] border rounded-lg text-center mt-3 hover:bg-[#1A51A2] hover:opacity-80 text-white font-semibold cursor-pointer'
//                           onClick={BuyNow}
//                         >
//                           Mua ngay
//                         </div>
...
//             title={data.data.data.product_name}
//             items={images1}
//             currentIndex={currentIndex}
//           />

//           <ModalChatZalo OpenModalChat={OpenModalChat} setOpenModalChat={setOpenModalChat} />
//         </>
//       )}
//     </div>
//   )
          ...
          {data?.data?.data && (
            <div className='bg-white grid grid-cols-1 md:grid-cols-12 gap-6'>
              <div className='col-span-12 md:col-span-9 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 ml-0 md:ml-4'>
                ...
                {/* end trai:    */}
                <div className='bg-white md:col-span-2 border-b-2 col-span-12 '>
                  <div className='relative top-0 md:hidden block'>
                    <ImageGallery
                      ref={refGallery}
                      items={images1}
                  ...
                  <div class='gap-3 md:gap-4 mb-3 md:mb-4 grid grid-cols-1'>
                    <div class='bg-divider h-[1px] -mx-4 md:mx-0'></div>
                    <div class='grid gap-3 md:gap-2 grid grid-cols-1'>
                      <div class='grid grid-cols-1 gap-1.5 md:grid-cols-[1fr,291px]'>
                        <p class='text-[14px] leading-[20px] font-semibold md:text-base'>Tên sản phẩm</p>
                        <div class='[&amp;_a:not(.ignore-css_a)]:text-hyperLink md:text-base'>
                          {data.data.data.product_name}
              ...
              <div className='col-span-12 md:col-span-3 bg-white ml-2 '>
                <div className='sticky top-0 border p-3 rounded-md'>
                  {data?.data?.data.parent_category_name === 'Thuốc kê đơn' ? (
                    <>
                      <div className='font-semibold'>Hệ thống nhà thuốc</div>
                      <div className='my-6'>
                        ...
                        <button
                          className='text-center w-full mt-2 bg-blue rounded-lg p-2'
                          onClick={() => {
                            setOpenModalChat(true)
                          }}
                        >
