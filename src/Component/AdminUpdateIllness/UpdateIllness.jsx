...
const UpdateIllness = () => {
  ...
  const handleValidate = () => {
    ...
    return name && generalOverview && symptoms && cause && riskSubjects && diagnosis && prevention && treatmentMethod
  }
    ...
    <section className='w-full test'>
      ...
      <header className='animate-slideDown flex justify-between items-start w-full sticky top-0 z-10 bg-[#f7f8fa]'>
        <div className='flex flex-col gap-1'>
          ...
          />
          <p>
            Update disease, those field with <span className='text-red-500'>*</span> are required.
          </p>
        </div>
        <button
          type='button'
